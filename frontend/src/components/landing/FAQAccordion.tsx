...
const faqs = [
  {
    q: "Does Recovio send emails from my domain or yours?",
    a: "Your domain, via your own SendGrid, SMTP, or Resend credentials. We never send collection emails from a Recovio address — every outbound email is from your verified sending domain, preserving your sender reputation and brand identity.",
  },
  {
  ...
  {
    q: "Does Recovio integrate with our accounting software?",
  ...
  {
    q: "Is Recovio free to use?",
    a: "Yes — Recovio is 100% free during Early Access with zero credit card required. You get full access to all autonomous AR capabilities with no artificial invoice limits or expiration dates.",
  },
  {
  ...
  },
  {
    ...
    a: "Only your team. Recovio is fully multi-tenant with cryptographic data isolation. Recovio staff do not access customer data except under an agreed Data Processing Addendum (DPA) for Enterprise plans, and only for support purposes with explicit written consent.",
  },
  {
    q: "What happens if an email fails to deliver?",
    a: "Recovio's Dead Letter Queue automatically retries failed deliveries with exponential backoff. Persistent failures trigger an operations alert and are surfaced in your dashboard so no invoice falls through the cracks silently.",
  },
];

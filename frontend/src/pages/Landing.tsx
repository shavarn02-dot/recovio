...
/* ─── Recovio brand logo as SVG mark ──────────────────────────────── */
function RecovioMark({ size = 22 }: { size?: number }) {
  return (
    <img
      src={recovioLogo}
      alt="Recovio"
    ...
    <section className="gl-hero">
      ...
      >
        ...
        <div className="gl-hero-sub-wrap">
          ...
          >
            Put your accounts receivable on autopilot. Recovio orchestrates intelligent collection cadences,
...
function HowItWorks() {
  ...
  const steps = [
    ...
    },
    {
      ...
      body: "Create invoices directly or import via CSV. Recovio reads debtor details, amounts, and due dates, mapping each invoice to the correct escalation stage immediately.",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "start" }} ref={ref}>
          ...
          <div style={{ position: "sticky", top: 72 }}>
            ...
            <p className={`gl-body gl-reveal${inView ? " visible" : ""}`} style={{ maxWidth: 340, transitionDelay: "0.16s", marginBottom: 28 }}>
              Recovio is operational in under a day. Your first automated collection cycle runs before your next stand-up.
            </p>
            <Link to="/register" className="gl-btn-demo">
      ...
      <div className="gl-section" ref={ref}>
        <div style={{ marginBottom: 36 }}>
          ...
          <p className={`gl-body gl-reveal${inView ? " visible" : ""}`} style={{ maxWidth: 520, paddingTop: 6, transitionDelay: "0.14s" }}>
            Whether you bill monthly subscriptions, consulting fees, or commercial orders, Recovio automates follow-ups, payment plans, and dispute triage.
          </p>
        </div>
      ...
      <div className="gl-section" ref={ref}>
        ...
        >
          ...
          <div className="gl-spotlight-img-wrap">
            ...
            {/* Ambient Recovio ice-blue & navy glow overlay */}
            <div
              style={{
                position: "absolute",
                inset: 0,
          ...
          <div className="gl-spotlight-content">
            ...
            <p className="gl-spotlight-quote" style={{ fontStyle: "normal" }}>
              Manual AR follow-ups are time-consuming and uncomfortable for finance teams. Recovio runs as a continuous background engine — tracking due dates across aging buckets, dispatching multi-stage escalation notices, and immediately holding cadences the second a debtor pays or opens a dispute.
            </p>
  ...
  return (
    <footer className="gl-footer">
      ...
      <div className="gl-footer-bottom">
        <span>© {new Date().getFullYear()} Recovio. All rights reserved.</span>
    ...
    <>
      <header className={`gl-nav${scrolled ? " scrolled" : ""}`}>
        <a href="/" className="gl-nav-logo">
          <RecovioMark size={22} />
          <span className="gl-nav-logo-text">Recovio</span>
        </a>
...
export function Landing() {
  return (
    <div className="gl-root">
      <SEOHead
        title="Recovio — AI-Powered Accounts Receivable Automation"
        description="Automate B2B collections with Recovio's AI agent: 5-stage tone escalation, dispute triage, and zero-login debtor portals. 100% free early access."
        canonicalPath="/"
      />
      <Nav />
      <main>

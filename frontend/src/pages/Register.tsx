...
export function Register() {
  ...
  return (
    <section className="min-h-screen bg-[#050505] text-white antialiased [font-synthesis:none]">
      <SEOHead
        title="Start Free"
        description="Create your free Recovio account and automate accounts receivable with AI-powered 5-stage collection escalation. No credit card required."
      ...
      <div className="grid min-h-screen lg:grid-cols-[0.94fr_1.06fr]">
        ...
        {/* Right Side - Marketing Testimonial and Recovio Mockup with Fluted Glass Aesthetics */}
        <div className="relative flex min-h-[720px] flex-col overflow-hidden bg-gradient-to-b from-[#071551] via-[#060913] to-[#040507] p-8 text-white sm:p-12 lg:min-h-screen lg:p-16">
          ...
          <div className="relative z-10 h-full w-full flex flex-col justify-between">
            ...
            {/* Tilted 3D Stacked Cards Deck (Authentic Recovio Invoices & Aging Ledger) */}
            <motion.div

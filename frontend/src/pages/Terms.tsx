  ...
  return (
    ...
    >
      <SEOHead
        ...
        description="Terms of Service governing use of the Recovio accounts receivable automation platform. Covers acceptable use, data handling, service levels, and liability."
        canonicalPath="/terms"
        ...
        >
          ...
          >
            ...
            <section>
              ...
              <p>
                Recovio is an accounts-receivable automation platform that enables businesses ("Customers") to automate the sending of collection communications to their own clients ("Debtors"), manage inbound replies, classify disputes, and administer structured payment plans. The Service operates as a software-as-a-service (SaaS) product accessible via web browser.
              </p>
            </section>
            ...
            <section>
              ...
              <p style={{ marginTop: "12px" }}>
                You must enable multi-factor authentication (MFA) on admin and manager accounts. Recovio reserves the right to suspend accounts that show signs of compromise or suspicious activity without prior notice.
              </p>
              <p style={{ marginTop: "12px" }}>
            ...
            <section>
              ...
              <ul style={{ paddingLeft: "20px", marginTop: "12px", display: "flex", flexDirection: "column", gap: "8px" }}>
                ...
                <li>Resell, sublicense, or make the Service available to third parties without written consent from Recovio.</li>
              </ul>
              <p style={{ marginTop: "12px" }}>
                Recovio reserves the right to suspend or terminate accounts that violate this Acceptable Use Policy without refund.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                You are solely responsible for the accuracy of the invoice and debtor data you input into Recovio, and for ensuring that your use of the Service complies with all applicable debt collection laws in your jurisdiction. Recovio acts as a technology service provider, not a debt collection agency, and is not responsible for the content of communications you send or for their legal compliance.
              </p>
              <p style={{ marginTop: "12px" }}>
            ...
            <section>
              ...
              <p style={{ marginTop: "12px" }}>
                Recovio reserves the right to modify pricing with 30 days' notice to existing subscribers.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                You retain full ownership of your Customer Data (invoice data, debtor data, and communications). You grant Recovio a limited licence to process your Customer Data solely for the purpose of operating the Service. Recovio will not use your Customer Data for any other purpose, including training AI models, without your explicit written consent.
              </p>
              <p style={{ marginTop: "12px" }}>
                For Enterprise customers requiring a formal Data Processing Addendum (DPA) under GDPR, UK GDPR, or equivalent regulation, contact support@recovio.site.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Recovio and its licensors retain all intellectual property rights in and to the Service, including the software, design, trademarks, and documentation. Nothing in these Terms grants you any rights in the Recovio brand, software, or intellectual property beyond the limited right to use the Service as described herein.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Recovio strives to maintain high availability but does not guarantee uninterrupted access to the Service. We reserve the right to modify, suspend, or discontinue any feature of the Service at any time, with notice where reasonably practicable. We will provide at least 30 days' notice of any discontinuation of a material feature for paid subscribers.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, RECOVIO'S TOTAL LIABILITY TO YOU FOR ANY CLAIM ARISING FROM THESE TERMS OR THE USE OF THE SERVICE SHALL NOT EXCEED THE GREATER OF (A) THE FEES YOU PAID TO RECOVIO IN THE TWELVE MONTHS PRECEDING THE CLAIM OR (B) $100. RECOVIO SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOST REVENUE, LOST PROFITS, OR LOSS OF DATA.
              </p>
            </section>
            ...
            <section>
              ...
              >
                <strong>Recovio</strong><br />
                Email: support@recovio.site
              </div>
            </section>

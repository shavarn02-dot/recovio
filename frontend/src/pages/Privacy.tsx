  ...
  return (
    ...
    >
      <SEOHead
        ...
        description="How Recovio collects, uses, and protects your data. Learn about our privacy practices, data retention, multi-tenant isolation, and your rights."
        ...
        >
          ...
          >
            <section>
              ...
              <p>
                Recovio ("we", "us", or "our") is an accounts-receivable automation platform. This Privacy Policy explains how we collect, use, share, and protect information about you when you use our website at recovio.site (the "Site") and our software-as-a-service platform (collectively, the "Service").
              </p>
            ...
            <section>
              ...
              <p style={{ marginTop: "12px" }}>
                We may disclose information if required by law, court order, or governmental authority, or to protect the rights, property, or safety of Recovio, our customers, or others.
              </p>
            </section>
            ...
            <section>
              ...
              <p style={{ marginTop: "12px" }}>
                You may request deletion of your account and associated data at any time by contacting us at support@recovio.site.
              </p>
            </section>
            ...
            <section>
              ...
              <p style={{ marginTop: "12px" }}>To exercise any of these rights, contact us at support@recovio.site.</p>
            </section>
            ...
            <section>
              ...
              <p>
                Recovio may process your data in countries outside your country of residence. Where data is transferred outside the EEA, UK, or other jurisdictions with specific transfer restrictions, we ensure appropriate safeguards are in place (such as Standard Contractual Clauses) as required by applicable law.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                The Recovio platform uses session cookies (strictly necessary for authentication) and does not set tracking or advertising cookies. The marketing site (recovio.site) may use analytics cookies to measure page performance. You may disable cookies in your browser settings; doing so will not prevent access to the core Service but may affect analytics features.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                The Service is not directed to individuals under 18. We do not knowingly collect personal data from minors. If you believe we have collected such data, contact us immediately at support@recovio.site.
              </p>
            </section>

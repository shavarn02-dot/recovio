    ...
    <>
      ...
      <Suspense fallback={<RouteFallback />}>
        <Routes>
          ...
          <Route path="/compare/highradius-vs-recovio" element={<HighRadiusCompare />} />
          <Route path="/compare/highradius-alternative" element={<Navigate to="/compare/highradius-vs-recovio" replace />} />
